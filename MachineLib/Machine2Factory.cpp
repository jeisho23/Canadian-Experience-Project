...
//
    ...
    // The snow blower
    //
    auto blower =  std::make_shared<SnowBlower>(mImagesDir, 2);
    machine->AddComponent(blower);
    blower->SetPosition(Post2X, -150);
    blower->InitialRot(0.15);
    machine->AddComponent(blower);
    ...
    pulley1->SetPosition(MotorX, -38 - 80 / 2);
//    pulley1->SetPosition(MotorX, -38 - Motor::Size / 2);
    ...
    pulley2->SetPosition(Post2X, post2->GetY() - Post2Height + 10);
    ...
    pulley4->SetPosition(Post1X, post1->GetY() - Post1Height + 10);
...
// The flag
    ...
    flag->SetLocation(pulley4->GetPosition().x, pulley4->GetPosition().y);
